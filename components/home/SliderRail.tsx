    ...
    <section className="bg-black">
      <div className="mx-auto max-w-6xl px-4 py-12 md:py-16">
        ...
        <div className="mt-6 flex snap-x snap-mandatory gap-4 overflow-x-auto pb-4 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden" role="region" aria-label="WeDesi highlights">
          {slides.map((s) => (
            <Link key={s.title} href={s.href} className="snap-start min-w-[80%] sm:min-w-[50%] lg:min-w-[33%] rounded-2xl border border-white/10 bg-white/5 p-5 text-white transition hover:border-white/20 hover:translate-y-[-2px]">
